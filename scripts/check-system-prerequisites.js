...
// Collects the diagnostics. env and homedir are injectable for tests.
function collectChecks({ env = process.env, homedir = os.homedir(), nodeVersion = process.version } = {}) {
    const checks = [];
...
module.exports = { MIN_NODE_MAJOR, collectChecks };
